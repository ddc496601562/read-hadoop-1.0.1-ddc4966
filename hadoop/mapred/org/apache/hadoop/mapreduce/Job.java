...
public class Job extends JobContext {  
  ...
  /**
   * 状态确认的一个操作，在执行kill fail等很多操作时候都会先确认状态 ，
   * 比如提交时候需要状态为DEFINE  ，kill 、fail时候需要状态为RUNNING，确保当前操作是在合适的状态下 
   * @param state 
  ...
  public void submit() throws IOException, InterruptedException, 
    ...
    //做连接操作，主要是连上JobTracker的JobSubmissionProtocol  RPC
    connect();
